...
public class SelectPhoneNumberToCharge implements MenuProperty{
        private static SelectPhoneNumberToCharge instance = new SelectPhoneNumberToCharge();

        public static SelectPhoneNumberToCharge getInstance() {
            return instance;
        }
        ...
        public static void handleTheUserMenu(SelectWay options, Bank myBank, UserAccount myAccount) {
            ...
            switch (options) {
//                case  SELECT_MANUALLY-> chargeSIM.implementAccountManagement(myAccount);
//                case  SELECT_FROM_CONTACTS-> chargeSIM.implementContacts(myAccount);
//                case  CHARGE_YOUR_SIM_CARD-> chargeSIM.implementMoneyTransfer(myAccount, myBank);
